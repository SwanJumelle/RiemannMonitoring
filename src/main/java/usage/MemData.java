...
public class MemData implements Serializable {
	...
	public MemData(ArrayList<String> data){
        this.memBuffers = Integer.parseInt(data.get(2));;
        this.memCached = Integer.parseInt(data.get(3));;
        this.memFree = Integer.parseInt(data.get(1));;
        this.memTotal = Integer.parseInt(data.get(0));
        this.memUsed = memTotal-memFree;	
	}
